...
jQuery(document).ready(function() {
    ...
    */
	$('.top-content').backstretch("static/users/assets/img/backgrounds/btc-bg.jpg");
    $('.section-4-container').backstretch("static/users/assets/img/backgrounds/btc-bg.jpg");
    $('.section-6-container').backstretch("static/users/assets/img/backgrounds/btc-bg.jpg");
